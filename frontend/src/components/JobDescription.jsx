    ...
    return (
        <div className='max-w-6xl mx-auto my-10'>
            <div className='flex items-center justify-between'>
                <div>
                    <h1 className='font-bold text-xl mx-1'>{singleJob?.title}</h1>
                ...
                <div>
                    ...
                    onClick={isApplied ? null : applyJobHandler}
                        className={`rounded-lg ${isApplied ? 'bg-gray-600 cursor-not-allowed' : 'bg-[#6A38C2] hover:bg-[#8756db]'}`}>
            ...
            <div className='my-4'>
                ...
                <h1 className='font-bold my-1'>Posted Date : <span className='pl-4 font-normal text-gray-800'>{singleJob?.createdAt}</span></h1>
            </div>
        </div>
    )
}
